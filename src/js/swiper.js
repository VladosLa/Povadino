const slider = document.querySelector('.awards__swiper');
const container = document.querySelector('.awards__swiper-wrapper');
const slides = document.querySelectorAll('.awards__slide');
const navigations = document.querySelectorAll('.awards__navigation');
...
function update() {
    ...
    for (let i = 0; i < slides.length; i++) {
        const leftSlide = document.querySelector(
            `.awards__slide[data-order="${activeOrder - i}"]`
        );
